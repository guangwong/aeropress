var rules = [{"symbol":"BLANK", "reg":/^\s+/, "fn":null},{"symbol":"ID", "reg":/^\w[\w\d]?/, "fn":null},{"symbol":"AND", "reg":/^&/, "fn":null},{"symbol":"NUMBER", "reg":/^\d+/, "fn":null}];
var lexer_buffer = "";
var lexer_context = {
    pos : 0,
    ln : 0,
...
lexer_in("x1 & 1233");console.log(lexer_out());console.log(lexer_out());console.log(lexer_out());console.log(lexer_out());console.log(lexer_out());